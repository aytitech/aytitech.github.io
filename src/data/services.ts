...
export const services: Service[] = [
	{
		slug: 'sovereign-cloud-native-platform', group: 'Platform', color: 'blue',
		en: { title: 'Sovereign Cloud Native Platform', summary: 'Run a modern application platform where your data, infrastructure and operating model remain under your control.', capabilities: ['Sovereignty and architecture assessment', 'Kubernetes platform and open-source foundations', 'GitOps, CI/CD and developer self-service', 'Managed operations, security and resilience', 'Team enablement and knowledge transfer'], outcomes: ['Control over data location and platform operations', 'Reduced dependency on any single infrastructure provider', 'A portable Cloud Native operating model', 'Transparent and optimizable total cost of ownership', 'An enabled internal team, not a black box'] },
		tr: { title: 'Sovereign Cloud Native Platform', summary: 'Verinizin, altyapınızın ve işletim modelinizin kontrolü sizde kalırken modern bir uygulama platformu çalıştırın.', capabilities: ['Veri egemenliği ve mimari değerlendirme', 'Kubernetes platformu ve açık kaynak temeller', 'GitOps, CI/CD ve developer self-service', 'Yönetilen operasyon, güvenlik ve dayanıklılık', 'Ekip yetkinleştirme ve bilgi transferi'], outcomes: ['Veri konumu ve platform operasyonu üzerinde kontrol', 'Tek bir altyapı sağlayıcısına daha düşük bağımlılık', 'Taşınabilir Cloud Native işletim modeli', 'Şeffaf ve optimize edilebilir toplam sahip olma maliyeti', 'Black box yerine yetkinleşmiş iç ekip'] },
	},
	{
